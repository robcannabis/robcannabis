...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/1102239223681130516/1134009886443831306/khuntae_rob.gif']; //รูปใหญ่
    ...
    const change2 = ['@ RobShop','@ รับเติมไนโตร','@ Boost 14O ฿','@ Classic 72 ฿']; // ชื่อสลับ
   ...
   const iooi = ['꒰ Join Server ꒱','꒰ RobShop ꒱','꒰ Boost 14O ฿ ꒱','꒰ Classic 72 ฿꒱']; // ชื่อ button 2
